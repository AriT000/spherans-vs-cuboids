...
public class BossLaserProjectile : MonoBehaviour
{
    ...
    [Header("Movement")]
    [SerializeField] private ProjectileMode mode = ProjectileMode.Straight;
    ...
    private void Update()
    {
        ...
        if (mode == ProjectileMode.HomingThenLock && !isLocked)
            HomingMove();
    ...
    public void Initialize(Transform target, Vector2 direction, float newSpeed)
    {
        player = target;
